...
================================================================================
  ...
  STEP 1 -- Install all tools (run once)
      ...
      Installs: Docker Desktop, Chocolatey, Terraform, AWS CLI v2,
                Python, LocalStack CLI, tflocal
  ...
  STEP 4 -- Run the labs (run scripts in order for each lab)
      ...
      LAB 04 -- Lambda Functions
          ...
          .\01-create-files.ps1
          .\02-restart-localstack-for-lambda.ps1   (only if LocalStack is already
                                                    running from a previous lab)
